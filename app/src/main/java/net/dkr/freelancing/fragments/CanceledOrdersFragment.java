...
public class CanceledOrdersFragment extends Fragment {
    RecyclerView rvCanceleddOrders;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       return inflater.inflate(R.layout.fragment_canceled_orders_, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvCanceleddOrders =view.findViewById(R.id.rv_canceled_orders);

        rvCanceleddOrders.setLayoutManager(new LinearLayoutManager(getActivity()));
                ...
                public void onResponse(Call<GigOrderModel[]> call, Response<GigOrderModel[]> response) {
                    if (response.isSuccessful()){
                        ...
                        for (int i = 0; i < gigOrderModelList.size(); i++) {
                            if (gigOrderModelList.get(i).status.equals("cancel"));
                        ...
                        rvCanceleddOrders.setAdapter(adapterGigOrder);
                    }else {
